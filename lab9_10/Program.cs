...
namespace lab9_10
{
    class Program
    {
        ...
        public void AssignNewKey()
        {
            ...
            File.WriteAllText("HorbunOleksandr.xml", rsa.ToXmlString(false));
        }
        ...
        public bool VerifySignature(byte[] hashOfDataToSign, byte[] signature)
        {
            using (var rsa = new RSACryptoServiceProvider())
            {
                ...
                rsa.FromXmlString(File.ReadAllText("HorbunOleksandr.xml"));
        ...
        {
            var doc = Encoding.UTF8.GetBytes("Oleksandr's Horbun document");
